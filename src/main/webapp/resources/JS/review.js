        ...
        if(this.readyState == 4 && this.status == 200){
            ...
            for(let i=0;i<ar.length;i++){
                ...
                if(!ar[i].rvCommentDTOs[0].rvcNum){
                    ...
                    src.value="/resources/upload/reviewfile/"+ar[i].rvFileDTOs[0].fileName;
                    ...
                    for(let j=0;j<ar[i].rvCommentDTOs.length;j++){
                        ...
                        let tdText = document.createTextNode(ar[i].rvCommentDTOs[j].rvcWriter);
                        td.appendChild(tdText);
                        tr.appendChild(td);
                        ...
                        tdText = document.createTextNode(ar[i].rvCommentDTOs[j].rvcContents);
                        td.appendChild(tdText);
                        tr.appendChild(td);
                        ...
                        attr.value = ar[i].rvCommentDTOs[j].rvcNum;
                        button.setAttributeNode(attr);
                        ...
                        attr1.value = ar[i].rvCommentDTOs[j].rvcNum;
                        button.setAttributeNode(attr1);
